...
// Renderiza la navegación principal, acceso a la cuenta y menú móvil adaptable.
    ...
    <header className="app-header">
      <nav className="nav-container">
        <Link className="brand" to="/" onClick={close}>
          <Shirt size={18} strokeWidth={2} className="brand-icon" aria-hidden="true" />
          Dona <span>y Viste</span>
        </Link>
