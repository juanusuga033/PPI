...
export default function Admin() {
  ...
  const loadAdminData = useCallback(async () => {
    setLoading(true)
    setError('')
    const [{ data: userData, error: userError }, { data: publicationData, error: publicationError }] = await Promise.all([
    ...
    if (userError || publicationError) setError('No fue posible cargar el centro de administración. Verifica que la migración de roles esté aplicada.')
    else {
      setUsers(userData || [])
  ...
  return <div className="admin-page">
    ...
    {loading ? <div className="page-state">Preparando el centro de control...</div> : <div className="admin-grid">
